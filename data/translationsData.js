...
const PARAMPARA_TRANSLATIONS = {
  en: {
    ...
    revival_subtitle:
      'Documenting fading practices, preserving oral histories, and connecting communities working to bring traditions back to life.',
    revival_hero_badge: 'Heritage Recovery Initiative',
    revival_hero_cta: 'Explore Traditions',
    revival_stat_total: 'Documented Traditions',
    revival_stat_extinct: 'Extinct or Dormant',
    revival_stat_reviving: 'Actively Reviving',
    revival_stat_community: 'Community Contributions',
    revival_search_placeholder: 'Search by title, village, or category...',
    revival_filter_all_categories: 'All Categories',
    revival_filter_all_states: 'All States',
    revival_filter_all_status: 'All Statuses',
    revival_status_extinct: 'Extinct',
    revival_status_endangered: 'Endangered',
    revival_status_documented: 'Documented',
    revival_status_reviving: 'Reviving',
    revival_status_revived: 'Revived',
    revival_contribute_title: 'Share a Lost Tradition',
    revival_contribute_subtitle:
      'Know of a fading practice? Contribute to the archive. Submissions are saved locally in your browser.',
    revival_form_name: 'Tradition Name',
    revival_form_village: 'Village',
    revival_form_state: 'State',
    revival_form_description: 'Description',
    ...
    words: 'words',
    minutes: 'min',
    paths_filter_theme_label: 'Filter by Theme',
    paths_filter_all_themes: 'All Themes',
    paths_sort_label: 'Sort by',
    paths_sort_default: 'Default',
    paths_sort_item_count: 'Number of Items',
    paths_order_label: 'Order',
    paths_order_asc: 'Least → Most',
    paths_order_desc: 'Most → Least',
    paths_clear_filters_btn: 'Clear All',
  ...
  hi: {
    ...
    revival_subtitle:
      'मिटती प्रथाओं का दस्तावेजीकरण, मौखिक इतिहास का संरक्षण, और परंपराओं को पुनर्जीवित करने वाले समुदायों को जोड़ना।',
    revival_hero_badge: 'विरासत पुनर्प्राप्ति पहल',
    revival_hero_cta: 'परंपराएं खोजें',
    revival_stat_total: 'दर्ज परंपराएं',
    revival_stat_extinct: 'विलुप्त या निष्क्रिय',
    revival_stat_reviving: 'सक्रिय पुनरुत्थान',
    revival_stat_community: 'सामुदायिक योगदान',
    revival_search_placeholder: 'शीर्षक, गांव या श्रेणी से खोजें...',
    revival_filter_all_categories: 'सभी श्रेणियां',
    revival_filter_all_states: 'सभी राज्य',
    revival_filter_all_status: 'सभी स्थितियां',
    revival_status_extinct: 'विलुप्त',
    revival_status_endangered: 'संकटग्रस्त',
    revival_status_documented: 'दर्ज',
    revival_status_reviving: 'पुनरुत्थान',
    revival_status_revived: 'पुनर्जीवित',
    revival_contribute_title: 'लुप्त परंपरा साझा करें',
    revival_contribute_subtitle:
      'किसी मिटती प्रथा के बारे में जानते हैं? संग्रह में योगदान दें। प्रविष्टियां आपके ब्राउज़र में स्थानीय रूप से सहेजी जाती हैं।',
    revival_form_name: 'परंपरा का नाम',
    revival_form_village: 'गांव',
    revival_form_state: 'राज्य',
    revival_form_description: 'विवरण',
    revival_form_references: 'संदर्भ',
    revival_form_references_placeholder: 'पुस्तकें, बुजुर्ग, अभिलेखागार, या लिंक...',
    revival_form_submit: 'योगदान जमा करें',
    ...
    words: 'शब्द',
    minutes: 'मिनट',
    paths_filter_theme_label: 'थीम से फ़िल्टर करें',
    paths_filter_all_themes: 'सभी थीम',
    paths_sort_label: 'क्रमबद्ध करें',
    paths_sort_default: 'डिफ़ॉल्ट',
    paths_sort_item_count: 'आइटमों की संख्या',
    paths_order_label: 'क्रम',
    paths_order_asc: 'कम → ज़्यादा',
    paths_order_desc: 'ज़्यादा → कम',
    paths_clear_filters_btn: 'सभी साफ़ करें',
  ...
  mr: {
    ...
    revival_subtitle:
      'नष्ट होत असलेल्या प्रथांचे दस्तऐवजीकरण, मौखिक इतिहासाचे संरक्षण, आणि परंपरा परत आणणाऱ्या समुदायांना जोडणे.',
    revival_hero_badge: 'वारसा पुनर्प्राप्ती उपक्रम',
    revival_hero_cta: 'परंपरा शोधा',
    revival_stat_total: 'नोंदणीकृत परंपरा',
    revival_stat_extinct: 'नष्ट किंवा निष्क्रिय',
    revival_stat_reviving: 'सक्रिय पुनरुज्जीवन',
    revival_stat_community: 'सामुदायिक योगदान',
    revival_search_placeholder: 'शीर्षक, गाव किंवा श्रेणीने शोधा...',
    revival_filter_all_categories: 'सर्व श्रेणी',
    revival_filter_all_states: 'सर्व राज्ये',
    revival_filter_all_status: 'सर्व स्थिती',
    revival_status_extinct: 'नष्ट',
    revival_status_endangered: 'धोक्यात',
    revival_status_documented: 'नोंदणीकृत',
    revival_status_reviving: 'पुनरुज्जीवन',
    revival_status_revived: 'पुनर्जीवित',
    revival_contribute_title: 'हरवलेली परंपरा सामायिक करा',
    revival_contribute_subtitle:
      'नष्ट होत असलेल्या प्रथा बद्दल माहिती आहे? संग्रहात योगदान द्या. नोंदी तुमच्या ब्राउझरमध्ये स्थानिकरित्या जतन केल्या जातात.',
    revival_form_name: 'परंपरेचे नाव',
    revival_form_village: 'गाव',
    revival_form_state: 'राज्य',
    revival_form_description: 'वर्णन',
    revival_form_references: 'संदर्भ',
    revival_form_references_placeholder: 'पुस्तके, वडील, संग्रहालये, किंवा दुवे...',
    revival_form_submit: 'योगदान सादर करा',
    ...
    words: 'शब्द',
    minutes: 'मिनिटे',
    paths_filter_theme_label: 'थीमनुसार फिल्टर करा',
    paths_filter_all_themes: 'सर्व थीम',
    paths_sort_label: 'क्रमवारी',
    paths_sort_default: 'डीफॉल्ट',
    paths_sort_item_count: 'घटकांची संख्या',
    paths_order_label: 'क्रम',
    paths_order_asc: 'कमी → जास्त',
    paths_order_desc: 'जास्त → कमी',
    paths_clear_filters_btn: 'सर्व साफ करा',
