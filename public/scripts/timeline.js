...
const timelineData = [
  {
    ...
    category: 'Revival',
    description:
      'Community elders revived forgotten weaving techniques, preserving patterns passed down generations.',
  ...
  },
  {
    ...
    category: 'Festival',
    description:
      'The first recorded harvest festival celebrated the bounty of the monsoon season.',
  ...
  },
  {
    ...
    category: 'Craft',
    description:
      'A guild of potters standardized techniques, leading to a distinct regional style.',
  ...
  },
  {
    ...
    description:
      'Villagers organized the first post‑independence cultural showcase.',
  ...
  },
  {
    ...
    category: 'Modern Innovation',
    description:
      'Radio arrived, allowing oral stories to be broadcast across villages.',
  ...
  },
  {
    ...
    category: 'Craft',
    description:
      'A women‑led cooperative revitalized handloom production and income.',
  ...
  },
  {
    ...
    category: 'Village',
    description:
      'The first digital archive of photographs and recordings was created.',
  ...
  },
  {
    ...
    category: 'Village',
    description:
      'A curated heritage trail linked several villages for cultural tourism.',
